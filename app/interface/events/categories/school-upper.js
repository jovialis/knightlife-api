...
// 12 hrs
module.exports.refreshDelay = 43200;

module.exports.name = 'upper school';
...
module.exports.fetchUpdates = async () => {
    ...
    console.log('Finished updating upper school events.');
}
            ...
            if (eventDocument) {
                ...
                if (eventDocument.calendarRaw === raw) {
                    ...
                    try {
                        ...
                        console.log(`Updated upper school event ${ badge }`);
                    } catch (err) {
                        console.log(err);
                    }
                }
                ...
                try {
                    await mongoose.model('UpperSchoolEvent').create(digested);

                    console.log(`Created upper school event ${ badge }`);
                } catch (err) {
                    console.log(err);
                }
            }
